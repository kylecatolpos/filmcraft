...
$getInfoSql = "SELECT * FROM customer WHERE customerId = '$displayId' ";
...
while($getRow = mysqli_fetch_assoc($getResult)) {
    ...
    $profile_image  = $getRow['customerProfileImage'];
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                       ...
                       <form method="POST" action="../function/customer_profile.php" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <div class="col-xl-8">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <!-- Save changes button-->
                                            <button class="btn btn-primary" type="submit" name="actionCustomerProfile">Save changes</button>

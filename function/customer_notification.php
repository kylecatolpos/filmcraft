...
if($sess_user == 'customer') { 
   ...
   if($_POST["view"] != '')
  {
   ...
   WHERE notificationStatus = '0' AND notificationUserType IN (1,2,3) AND notificationCustomerId = '$session_id'
   ";
   mysqli_query($conn, $update_query);
  }

$query = "SELECT * FROM notification 
WHERE (notificationUserType IN (1,2,3) AND notificationCustomerId = '$session_id') AND notificationStatus = 0

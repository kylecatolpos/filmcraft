...
if($sess_user == 'admin') { 
   ...
   if($_POST["view"] != '')
  {
   ...
   WHERE notificationStatus = '0' AND notificationUserType IN (1) AND notificationAdminId = '$session_id'
   ";
   mysqli_query($conn, $update_query);
  }

$query = "SELECT * FROM notification 
WHERE (notificationUserType IN (1) AND notificationAdminId = '$session_id') AND notificationStatus = 0
